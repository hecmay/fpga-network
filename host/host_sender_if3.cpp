...
int main(int argc, char **argv) {
  ...
  unsigned int ip_gateway = argc >= 9
                                ? (unsigned int)strtol(argv[8], NULL, 16)
  ...
  unsigned int my_ip_address0 = argc >= 5
                                    ? (unsigned int)strtol(argv[4], NULL, 16)
                                    : (unsigned int)MY_IP_ADDR0;
  unsigned int their_ip_address0 = argc >= 7
  ...
  unsigned int my_ip_address1 = argc >= 8
                                    ? (unsigned int)strtol(argv[7], NULL, 16)
                                    : (unsigned int)MY_IP_ADDR1;
  unsigned int their_ip_address1 = argc >= 10
                                       ? (unsigned int)strtol(argv[9], NULL, 16)
